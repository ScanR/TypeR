...
if ($Lang -eq "fr") {
  ...
  $msg_install  = "A extensão Photoshop TypeR v$ExtVersion será instalada."
  ...
  $msg_credits  = "Muito obrigado ao Swirt pelo TyperTools e ao SeanR & Sakushi por este fork."
